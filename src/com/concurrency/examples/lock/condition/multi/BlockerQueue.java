package com.concurrency.examples.lock.condition.multi;
...
public class BlockerQueue {
	...
	public Object remove() {
		...
		try {
			if (currPointer == 0) {
				...
				System.out.println("In remove(): got notification that an element hasgot inserted");
			}
	...
	public static void main(String[] args) throws InterruptedException {
		//BlockerQueue.runCase1();
		
		BlockerQueue.runCase2();
	}

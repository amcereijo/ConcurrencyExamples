package com.concurrency.examples.exchanger;
...
public class KnockKnock {
	...
	// The DukeThread class runs as an independent thread. It talks to the
	// CoffeeShopThread that
	// also runs independently. The chat is achieved by exchanging messages
	// through a common
	// Exchanger<String> object that synchronizes the chat between them.
	// Note that the message printed are the "responses" received from
	// CoffeeShopThread

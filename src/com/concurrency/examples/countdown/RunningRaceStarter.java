package com.concurrency.examples.countdown;
...
public class RunningRaceStarter {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		new Runner(counter, "Joe", Thread.MAX_PRIORITY);
	...
	static class Runner extends Thread {
		...
		public Runner(CountDownLatch cdl, String name) {
			this(cdl, name, Thread.NORM_PRIORITY);
		}
		
		public Runner(CountDownLatch cdl, String name, int priority) {
			timer = cdl;
			this.setName(name);
